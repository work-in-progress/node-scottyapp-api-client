  ...
  exports.Client = (function() {
    ...
    */
    Client.prototype.authenticate = function(username, password, cb) {
      ...
      return this.post(url, data, __bind(function(err, payload, request, body) {
    ...
    */
    Client.prototype.apps = function(organizationOrUsername, cb) {
      var url;
    ...
    */
    ...
    /*
      ...
      urlFor : (action, self, options = null) ->
        ...
        params.join ''
      */
    Client.prototype.request = function(url, fn) {
      var headers;
      if (fn == null) {
        fn = function() {};
      }
    ...
    Client.prototype.post = function(url, payload, fn) {
      var headers;
      if (fn == null) {
        fn = function() {};
      }
